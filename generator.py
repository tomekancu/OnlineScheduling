...
class Generator:
    ...
    def __init__(self, n: int,
                 ...
                 # normal distribution of time spaces between tasks
                 mean_std_time_spaces: Tuple[float, float],
        ...
        self.mean_std_time_spaces = mean_std_time_spaces
    ...
    def generate(self):
        ...
        mean_time_spaces, std_time_spaces = self.mean_std_time_spaces
        time_spaces = np.random.normal(mean_time_spaces, std_time_spaces, self.n)
        time = []
        clock = 0
